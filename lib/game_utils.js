...
GameData.prototype.getLeaderboard = function(l) {
  ...
  return "The leaderboard will reset on Wednesday, November 1st, and several balance changes will be added to the game. When the reset occurs, the high scores will be recorded for bragging rights and glory.\n```" + table("Leaderboard", ["#", "Player", "Credits"], toPass, {
    title: 33,
    headers: [2, 20, 9]
  }) + "```";
};
